    ...
    var Lightbox = (function ($) {
        ...
        var Lightbox = (function () {
            ...
            function Lightbox($element, config) {
                ...
                $('<span></span>', {class: 'glyphicon glyphicon-zoom-in image-zoom'}).appendTo(this._$lightboxContainer);
                $('<br />').appendTo(this._$lightboxContainer);
                $('<span></span>', {class: 'glyphicon glyphicon-zoom-out image-zoom'}).appendTo(this._$lightboxContainer);
